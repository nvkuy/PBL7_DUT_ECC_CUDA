...
void **__T35)
{
__nv_dummy_param_ref(__T35);
__nv_save_fatbinhandle_for_managed_rt(__T35);
__cudaRegisterEntry(__T35, ((void ( *)(unsigned *, unsigned *))g_build_n3), _Z10g_build_n3PjS_, (-1));
__cudaRegisterEntry(__T35, ((void ( *)(unsigned *, unsigned *, unsigned *))g_build_n2), _Z10g_build_n2PjS_S_, (-1));
__cudaRegisterEntry(__T35, ((void ( *)(unsigned *, unsigned *, unsigned *, unsigned *, unsigned *))g_build_n1), _Z10g_build_n1PjS_S_S_S_, (-1));
__cudaRegisterEntry(__T35, ((void ( *)(unsigned *, unsigned *, unsigned *, unsigned, unsigned *, unsigned *, unsigned *))g_build_product_i), _Z17g_build_product_iPjS_S_jS_S_S_, (-1));
__cudaRegisterEntry(__T35, ((void ( *)(unsigned *, unsigned *))g_poly_deriv), _Z12g_poly_derivPjS_, (-1));
__cudaRegisterEntry(__T35, ((void ( *)(unsigned *, unsigned))g_fill), _Z6g_fillPjj, (-1));
__cudaRegisterEntry(__T35, ((void ( *)(unsigned *, unsigned *, unsigned *))g_vector_mul_i), _Z14g_vector_mul_iPjS_S_, (-1));
__cudaRegisterEntry(__T35, ((void ( *)(unsigned *, unsigned, bool, unsigned *))g_fnt_i), _Z7g_fnt_iPjjbS_, (-1));
__cudaRegisterEntry(__T35, ((void ( *)(unsigned *, unsigned, unsigned *))g_end_fnt), _Z9g_end_fntPjjS_, (-1));
__cudaRegisterEntry(__T35, ((void ( *)(unsigned *, unsigned *, unsigned, unsigned *))g_pre_fnt), _Z9g_pre_fntPjS_jS_, (-1));
}
static void __sti____cudaRegisterAll(void)
{
